  ...
  return (
    <AppShell>
      <div className="space-y-6">
        ...
        <Card title="Choose a file" subtitle="CSV only. We’ll parse the first rows for preview." tone="tint">
          <div className="space-y-4">
            <label className="block">
              <span className="text-xs font-medium text-[var(--color-secondary)]">Consumption CSV</span>
              <div className="mt-2 flex items-center gap-3 rounded-3xl bg-white/80 px-4 py-3 ring-1 ring-black/10 shadow-sm focus-within:ring-2 focus-within:ring-blue-600/50">
                <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-white ring-1 ring-black/5">
                  <FontAwesomeIcon icon={faFileCsv} className="h-4 w-4 text-blue-700" />
                </span>
                <input
                  type="file"
                  accept=".csv,text/csv"
                  ...
                  className="block w-full text-sm file:mr-4 file:rounded-2xl file:border-0 file:bg-blue-600 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-blue-700"
                />
              </div>
            </label>
